/*********************************************************************************
    Home Page v5 Preloader JS 
*********************************************************************************/
$(window).on("load", function () {
    $(".preloader-v5").fadeOut();
});

/*********************************************************************************
    Home Page v5 Header Menu JS 
 *********************************************************************************/
$(".navbar-toggler").click(function () {
    if ($(".homepage-v5-header .navbar-toggler").hasClass("collapsed")) {
        $(this).parents(".homepage-v5-header").removeClass("headerchanged");
    } else {
        $(this).parents(".homepage-v5-header").addClass("headerchanged");
    }
});

/*********************************************************************************
    Home Page v5 Sticky Header JS 
*********************************************************************************/
...
function myFunction() {
    if ($(window).scrollTop() > 0) {
        $(".homepage-v5-header").addClass("stickyNav");
    } else {
        $(".homepage-v5-header").removeClass("stickyNav");
    }
}

/*********************************************************************************
    Home Page v5 All Product JS 
*********************************************************************************/
$(document).ready(function () {
    //------- Initialising Slick Slider 1
    $(".homepage-v5-all-product-area-slider").slick({
        infinite: true,
        slidesToShow: 4,
        arrows: false,
        dots: false,
    ...
    //------- Custom Arrows Click Functionality 1
    $(document).on("click", ".homepage-v5-all-product-area-slider-prevSlide", function () {
        $(".homepage-v5-all-product-area-slider").slick("slickPrev");
    });

    $(document).on("click", ".homepage-v5-all-product-area-slider-nextSlide", function () {
        $(".homepage-v5-all-product-area-slider").slick("slickNext");
    });

    //------- Initialising Slick Slider 1
    $(".homepage-v5-all-product-area-slider2").slick({
        infinite: true,
        slidesToShow: 4,
        arrows: false,
        dots: false,
    ...
    //------- Custom Arrows Click Functionality 1
    $(document).on("click", ".homepage-v5-all-product-area-slider-prevSlide2", function () {
        $(".homepage-v5-all-product-area-slider2").slick("slickPrev");
    });

    $(document).on("click", ".homepage-v5-all-product-area-slider-nextSlide2", function () {
        $(".homepage-v5-all-product-area-slider2").slick("slickNext");
    });
});

/*********************************************************************************
    Home Page v5 All Product Color JS 
*********************************************************************************/
$(document).ready(function () {
    $(".homepage-v5-product-color-switch span").each(function () {
        var get_color = $(this).attr("data-color");
        $(this).css("background-color", get_color);
    });

    $(".homepage-v5-product-color-switch span").on("click", function () {
        $(this).siblings(this).removeClass("active").end().addClass("active");
    });
});

/*********************************************************************************
    Home Page v5 Deal Of The Day JS 
*********************************************************************************/
$(".homepage-v5-deal-of-the-day-clock-c").countdown("2022/04/28", function(event) {
    $(this).html(
        event.strftime(
            "" +
                '<div class="countdown-maindiv ms-0"><h2 class="title">%D</h2> <p class="subtitle">Days</p></div><span class="coma">:</span>' +
                '<div class="countdown-maindiv"><h2 class="title">%H</h2> <p class="subtitle">Hours</p></div><span class="coma">:</span>' +
                '<div class="countdown-maindiv"><h2 class="title">%M</h2> <p class="subtitle">Min</p></div><span class="coma">:</span>' +
                '<div class="countdown-maindiv"><h2 class="title">%S</h2> <p class="subtitle">Sec</p></div>'
        )
    );
});

//------- Home Page v5 Deal Of The Day Slider
$(".homepage-v5-deal-of-the-day-slider-for").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    dots: false,
    fade: true,
    asNavFor: ".homepage-v5-deal-of-the-day-slider-nav",
});
$(".homepage-v5-deal-of-the-day-slider-nav").slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    asNavFor: ".homepage-v5-deal-of-the-day-slider-for",
    arrows: false,
    dots: false,
    focusOnSelect: true, 
    responsive: [
...
/*********************************************************************************
    Home Page v5 Latest News JS 
*********************************************************************************/
$(document).ready(function () {
    //------- Initialising Slick Slider 1
    $(".homepage-v5-latest-news-blog-slider").slick({
        infinite: true,
        slidesToShow: 4,
        arrows: false,
        dots: false,
    ...
    //------- Custom Arrows Click Functionality 1
    $(document).on("click", ".homepage-v5-latest-news-blog-slider-prevSlide", function () {
        $(".homepage-v5-latest-news-blog-slider").slick("slickPrev");
    });

    $(document).on("click", ".homepage-v5-latest-news-blog-slider-nextSlide", function () {
        $(".homepage-v5-latest-news-blog-slider").slick("slickNext");
    });
});

/*********************************************************************************
    Home Page v5 Product Brands JS 
*********************************************************************************/
$(document).ready(function () {
    //------- Initialising Slick Slider 1
    $(".homepage-v5-product-brands-slider").slick({
        infinite: true,
        slidesToShow: 4,
        arrows: false,
        dots: false,
    ...
    //------- Custom Arrows Click Functionality 1
    $(document).on("click", ".homepage-v5-product-brands-slider-prevSlide", function () {
        $(".homepage-v5-product-brands-slider").slick("slickPrev");
    });

    $(document).on("click", ".homepage-v5-product-brands-slider-nextSlide", function () {
        $(".homepage-v5-product-brands-slider").slick("slickNext");
    });
});

/*********************************************************************************
    Home Page v5 Our Brand Logo JS 
*********************************************************************************/
$(document).ready(function () {
...
/*----------------- Home Page v5 Quick View Quantity -----------------*/
$(document).ready(function () {
    var quantity = 1;
...
/*********************************************************************************
    Home Page v5 Footer Back To Top Button JS 
*********************************************************************************/
$(function () {
    //Scroll event
